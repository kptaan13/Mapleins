    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="mt-3 text-4xl font-bold text-gray-900">We would love to hear from you</h1>
          <p className="mt-4 text-lg text-gray-600 max-w-xl mx-auto">
            Questions, feedback, success stories, or just want to say hi. Reach out and we will get back to you within 24 hours.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border p-5 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Got an interview or landed a job? Tell us. It helps motivate the next user.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border p-5 flex gap-4 items-start">
              ...
              <div>
                ...
                <a href="mailto:hello@mapleins.ca" className="text-sm text-[#166534] hover:underline mt-1 block">
                  hello@mapleins.ca
                </a>
              </div>
            </div>
