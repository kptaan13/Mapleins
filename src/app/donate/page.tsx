  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-20 text-center">
        <span className="text-4xl">Support</span>
        ...
        <div className="mt-12 bg-gray-50 rounded-2xl p-8 text-left space-y-4">
          ...
          <div className="flex gap-4 items-start">
            <span className="text-xl shrink-0">AI</span>
            <div>
              <p className="font-medium text-gray-800">AI processing</p>
              <p className="text-sm text-gray-500">Each resume analysis, generation, and job match costs us real money in API calls. $10 covers about 50 resumes.</p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            <span className="text-xl shrink-0">Free</span>
            <div>
              <p className="font-medium text-gray-800">Keeping it free</p>
              <p className="text-sm text-gray-500">We do not want a paywall. Donations keep Mapleins accessible to everyone.</p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            <span className="text-xl shrink-0">Roadmap</span>
            <div>
              <p className="font-medium text-gray-800">New features</p>
              <p className="text-sm text-gray-500">Cover letter builder, LinkedIn import, and French support are on the roadmap.</p>
            </div>
          </div>
        </div>
